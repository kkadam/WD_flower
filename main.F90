...
open(unit=928, file='output/diag.out', &
     form='formatted',status='unknown', position='append')
...
do I = 1, 10
   ...
   if ( I == 9 ) template = 'output/data/etot'
   if ( I == 10 ) template = 'output/data/pre'
