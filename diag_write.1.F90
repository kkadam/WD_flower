...
write(928,100) tstep, time/cirp, dt, diag_sum(24), diag_sum(26),       &
             diag_sum(27), diag_sum(28)

write(928,110) diag_sum(25), spin_star1, spin_star2, diag_sum(21),     &
             diag_sum(22), diag_sum(23)

write(928,120) diag_sum(1), diag_sum(2), diag_sum(3), diag_sum(4),     &
             diag_sum(1)+diag_sum(2)+diag_sum(3)+diag_sum(4),        &
             mtot, diag_sum(29)

write(928,130) rhomax1, rhomax2, rholoc1, rholoc2, irholoc1, irholoc2

write(928,140) syscom, star1com, star2com, syscomin, star1comin,       &
             star2comin

write(928,150) diag_sum(5:9)

write(928,160) diag_sum(10:14)

write(928,170) ilm

write(928,180) roche_vol1, roche_vol2, lpoints

write(928,190) mom1

write(928,200) mom2

write(928,210) etot1, ntot1, etot2, ntot2, etot1/ntot1, etot2/ntot2

write(928,220) diag_sum(30:36)

write(928,230) delt(1), phi_com, com(1,1), com(1,2), com(1,3), R_com
