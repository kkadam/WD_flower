...
!   advect etot:
if( advect_time == 1 ) then
   call slope(etot, qj, qk, ql)
   call flux(etot,qj,transu,dt,volinv_cc,1,retflx)
   do L= philwb, phiupb
      do K = zlwb, zupb
         do J = rlwb, rupb
            rettot(J,K,L) = retflx(J,K,L)
      ...
      enddo
   enddo
   call flux(etot,qk,transw,dt,volinv_cc,2,retflx)
   do L = philwb, phiupb
      do K = zlwb, zupb
         do J = rlwb, rupb
             rettot(J,K,L) = rettot(J,K,L) + retflx(J,K,L)
      ...
      enddo
   enddo
   call flux(etot,ql,transv,dt,volinv_cc,3,retflx)
   do L = philwb, phiupb
      do K = zlwb, zupb
         do J = rlwb, rupb
            etot(J,K,L) = etot(J,K,L) + rettot(J,K,L) + retflx(J,K,L)
         enddo
      enddo
   enddo
else
   call slope(etot1, qj, qk, ql)
   ! actually update rho due to advection
   call flux(etot1,qj,transu,dt,volinv_cc,1,retflx)
   do L = philwb, phiupb
      do K = zlwb, zupb
         do J = rlwb, rupb
           rettot(J,K,L) = retflx(J,K,L)
      ...
      enddo
   enddo
   call flux(etot1,qk,transw,dt,volinv_cc,2,retflx)
   do L = philwb, phiupb
      do K = zlwb, zupb
         do J = rlwb, rupb
            rettot(J,K,L) = rettot(J,K,L) + retflx(J,K,L)
      ...
      enddo
   enddo
   call flux(etot1,ql,transv,dt,volinv_cc,3,retflx)
   do L= philwb, phiupb
      do K = zlwb, zupb
         do J = rlwb, rupb
            etot(J,K,L) = etot1(J,K,L) + rettot(J,K,L) + retflx(J,K,L)
         enddo
      enddo
   enddo
endif
