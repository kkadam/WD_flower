...
!conts_template = 'input/conts/fort.12.470000.'
...
a_hat = kappa1
b_hat = kappa2
eight_a_b_hat = 8.00000000000000*a_hat/b_hat
...
!    endif
    ...
    read(8) s, t, a, rho, tau, pot, tempa, temps, frac1, frac2, etot
    close(8)

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! attempt to switch to another rotating coordinate frame. 
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!   do j = 3, numr-1
!     do L = 1, numphi_dd
!       do k = zlwb, zupb
!         a(j,k,l) = a(j,k,l) - rho(j,k,l)*r(j)*(0.35878800000000-0.243246434303537)*r(j)
!       enddo
!     enddo
!   enddo
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   if( iam_root ) then
     !open(unit=9, file='input/conts/fort.13.470000', &
